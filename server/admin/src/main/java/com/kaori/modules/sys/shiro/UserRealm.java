package com.kaori.modules.sys.shiro;
...
public class UserRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		info.setStringPermissions((Set<String>) com.kaori.modules.sys.shiro.ShiroUtils.getSession().getAttribute(CommonConst.PERMS_LIST));
		return info;
	}
