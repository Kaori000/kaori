package cn.runget.utils;

import cn.runget.entity.ColumnEntity;
import cn.runget.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		map.put("classname", tableEntity.getClassname());
		map.put("pathName", tableEntity.getClassname().toLowerCase().split(config.getString("moduleName" ))[1]);
